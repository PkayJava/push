...
public class NewVersionPage extends KnownPage {
    ...
    public Navigation okay() {
        ...
        insert.withTableName(TableUtilities.getTableName(com.itrustcambodia.push.entity.Version.class));
        Map<String, Object> fields = new HashMap<String, Object>();

        fields.put(com.itrustcambodia.push.entity.Version.NAME, this.name);
