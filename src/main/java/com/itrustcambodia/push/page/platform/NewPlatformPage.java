...
public class NewPlatformPage extends KnownPage {
    ...
    public Navigation okay() {
        ...
        insert.withTableName(TableUtilities.getTableName(com.itrustcambodia.push.entity.Platform.class));
        Map<String, Object> fields = new HashMap<String, Object>();

        fields.put(com.itrustcambodia.push.entity.Platform.NAME, this.name);
