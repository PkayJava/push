...
import com.itrustcambodia.push.entity.Feedback;
...
public class ApplicationMigration extends AbstractApplicationMigrator {
    ...
    public void patchVersion_0_02() {
        ...
        insertVersion.withTableName(TableUtilities.getTableName(com.itrustcambodia.push.entity.Version.class));
    ...
    public void patchVersion_0_01() {
        ...
        table = application.getSchema().getTable(TableUtilities.getTableName(com.itrustcambodia.push.entity.Version.class));
        if (!table.exists()) {
            application.getSchema().createTable(com.itrustcambodia.push.entity.Version.class, com.itrustcambodia.push.entity.Version.ID, com.itrustcambodia.push.entity.Version.NAME);
        }
    }
