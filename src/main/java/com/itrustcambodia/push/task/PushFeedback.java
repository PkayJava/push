                ...
                try {
                    ...
                    if (inactiveDevices != null && !inactiveDevices.isEmpty()) {
                        for (Device device : inactiveDevices) {
                            jdbcTemplate.update("update " + TableUtilities.getTableName(com.itrustcambodia.push.entity.Device.class) + " set " + com.itrustcambodia.push.entity.Device.FLAG + " = ? where " + com.itrustcambodia.push.entity.Device.TOKEN + " = ?", com.itrustcambodia.push.entity.Device.Flag.DELETE, device.getToken());
                        }
                    }
