package com.itrustcambodia.v5.page.model;
...
public class NewModelPage extends KnownPage {
    ...
    public Navigation okay() {
        ...
        insert.withTableName(TableUtilities.getTableName(com.itrustcambodia.v5.entity.Model.class));
        Map<String, Object> fields = new HashMap<String, Object>();

        fields.put(com.itrustcambodia.v5.entity.Model.NAME, this.name);
