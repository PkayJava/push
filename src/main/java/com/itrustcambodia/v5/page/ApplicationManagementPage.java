...
import com.itrustcambodia.v5.action.ApplicationActionPanel;
import com.itrustcambodia.v5.entity.Application;
import com.itrustcambodia.v5.provider.ApplicationSortableDataProvider;
...
public class ApplicationManagementPage extends WebPage {
    ...
    private void initializeInterceptor() {
        ...
        Long userId = jdbcTemplate.queryForObject("select " + com.itrustcambodia.v5.entity.User.ID + " from " + TableUtilities.getTableName(com.itrustcambodia.v5.entity.User.class) + " where " + com.itrustcambodia.v5.entity.User.LOGIN + " = ?", Long.class, session.getUsername());
