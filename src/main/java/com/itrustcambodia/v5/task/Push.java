...
public class Push extends Job {
    ...
    public static void main(String[] args) {
        Message message = new Message.Builder().addData("message", "test").collapseKey("sd").delayWhileIdle(true).build();

        Gson gson = new Gson();
        System.out.println(gson.toJson(message));
        Message p = gson.fromJson(gson.toJson(message), Message.class);
